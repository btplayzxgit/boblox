...
def home():
    ...
    def experiences(): root.destroy(); run(pyautogui.confirm(title='Boblox', text='Experiences\n', buttons=get_choices()))
    def experience_search(): root.destroy(); begin_search_gui()
    def settings(): root.destroy(); open_settings()
    ...
    boblox_label = Button(root, image=root.boblox_label, width=w-12, height=h*2-16, bd=0, relief='sunken')
